...
In Bayes Theorem the absolute loss is the median of the posterior. Based of this, the estimator that minimises the expected absolute error loss within the posterior for the proportion of students who passed is:
