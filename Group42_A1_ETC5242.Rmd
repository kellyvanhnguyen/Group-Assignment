...
Rxobs_tbl %>%
  ...
  ggtitle(expression(paste("Approximate sampling distribution of ", hat(p)[UG] - hat(p)[PG], " under ", H[0]))) +
...
The $p$-value of the test is 0.0246, which is less than 0.05, given a confidence level of 95%.
