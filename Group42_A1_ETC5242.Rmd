...
where ${p}_{P}$ and ${p}_{U}$ denote the population proportions of Post-Graduate and Under-Graduate students passing the quiz, respectively. **H0 statement, H1 statement?**
...
betaPG <- 1
nPG <- 48
LUstar_PG <- qbeta(c(0.025, 0.975), 42, 8)
LU_PG <- nPG * LUstar_PG
LU_PG
...
betaUG <- 1
nUG <- 145
LUstar_UG <- qbeta(c(0.025, 0.975), 103, 44)
LU_UG <- nUG * LUstar_UG
LU_UG
```
