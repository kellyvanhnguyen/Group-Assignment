...
xobs <- grades3$Prop[grades3$Cohort=='PG'] - grades3$Prop[grades3$Cohort=='UG']
...
Based on the plot and the p-value, we can say with 95% confidence that there is not enough evidence to reject the null hypothesis (H0), thus, it can be concluded that there is no difference between the grade rates of the postgraduate and the undergraduate students.
